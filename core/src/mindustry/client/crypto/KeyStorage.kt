...
class KeyStorage(private val dataDir: File, name: String) {
    ...
    init {
        if (dataDir.resolve(TRUST_STORE_FILENAME).exists()) {
            ...
            trustStore.setCertificateEntry("buthed", deserializeCert("".base64()!!)!!)
        }
